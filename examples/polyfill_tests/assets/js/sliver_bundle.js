(function() {
	...
	function mapArray(e, t, n) {
		...
		const s = {
			...
			et: [],
			tt: i,
			nt: i || n?.keyed === false ? [] : void 0,
			it: r && n?.keyed !== false ? [] : void 0,
			rt: n?.keyed === false,
			ot: n?.fallback
		};
	...
	function updateKeyedMap() {
		...
		runWithOwner(this.Ze, () => {
			let n, i, r = this.nt ? this.rt ? () => {
				...
				return this.Xe(accessor(this.nt[i]), this.it ? accessor(this.it[i]) : void 0);
			} : this.it ? () => {
				const t = e[i];
			...
			if (t === 0) {
				...
				if (this.ot && !this.Je[0]) this.Je[0] = runWithOwner(this.et[0] = createOwner(), this.ot);
			} else if (this.qe === 0) {
				...
				let o, s, u, c, l, a, f, E = new Array(t), S = new Array(t), T = this.nt ? new Array(t) : void 0, d = this.it ? new Array(t) : void 0;
				for (o = 0, s = Math.min(this.qe, t); o < s && (this.ze[o] === e[o] || this.nt && compare(this.tt, this.ze[o], e[o])); o++) if (this.nt) setSignal(this.nt[o], e[o]);
				...
				} else this.Je[i] = runWithOwner(this.et[i] = createOwner(), r);
