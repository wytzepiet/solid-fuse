(function() {
	...
	function createEffect$1(e, t, n) {
		effect$1(e, t.effect || t, t.error, {
			user: true,
			...n
		});
	}
	...
	if (globalThis.WebSocket === void 0) {
		...
		class n {
			constructor(n, r) {
				S(this, "_id", void 0), S(this, "url", void 0), S(this, "readyState", 0), S(this, "protocol", ""), S(this, "binaryType", "blob"), S(this, "bufferedAmount", 0), S(this, "extensions", ""), S(this, "onopen", null), S(this, "onmessage", null), S(this, "onclose", null), S(this, "onerror", null), this._id = t++, this.url = n, e.set(this._id, this), g("_ws", {
					op: "open",
					id: this._id,
					url: n,
		...
		S(n, "CONNECTING", 0), S(n, "OPEN", 1), S(n, "CLOSING", 2), S(n, "CLOSED", 3), h("_wsEvent", (t) => {
			let n = e.get(t.id);
			if (n) switch (t.type) {
				case "open":
	...
	var C = globalThis.__fuseHost;
	if (!C) throw Error("[solid-fuse] `host` is unavailable — it only exists inside a running solid-fuse app.");
	var [de, fe] = createSignal(C.brightness);
	h("_brightness", (e) => fe(e.value));
	var w = {
		brightness: de,
		platform: C.platform,
		mode: C.mode
		...
		constructor(e) {
			S(this, "id", pe++), S(this, "props", {}), S(this, "children", []), S(this, "parent", void 0), this.type = e;
		}
	}, D = /* @__PURE__ */ new Map();
	h("_functionCall", (e) => {
		let t = `${e.nodeId}:${e.name}`;
		D.get(t)?.(e.value);
	}), h("_functionCallAsync", (e) => D.get(`${e.nodeId}:${e.name}`)?.(e.value));
	var O = [], k = new E("root"), A = !1, j = !1;
	function M() {
		flush(), A = !1, O.length !== 0 && (g("_ops", { ops: O.slice() }), O.length = 0);
	}
	function N() {
	...
	function Ke(e) {
		return (() => {
			var t = R("sliverFillRemaining");
			return H(t, e, !1), t;
		})();
	}
	function $(e, t = {}) {
		let n = new E(e), r = {}, i = [];
		for (let [e, a] of Object.entries(t)) typeof a == "function" || a instanceof E || a?.node instanceof E ? i.push([e, a]) : (r[e] = a, n.props[e] = a);
		O.push({
			op: "create",
			id: n.id,
			type: e,
	...
	function ft(e) {
		let [t, n] = createSignal(e.initialIndex ?? 0), { node: r, call: i, dispose: a } = $("tabController", {
			length: e.length,
	...
	//#endregion
	//#region examples/demo/src/tabs-test-entry.tsx
	var controller = ft({ length: 2 });
	createEffect(() => controller.index(), (index) => g("test:tabIndex", { index }));
	b.on("test:jumpTo", (data) => {
	...
	var Explicit = () => G(ye, {
		...
		get children() {
			return [G(ke, {
				controller,
				get children() {
					return [G(Oe, { text: "tab-A" }), G(Oe, { text: "tab-B" })];
				}
			}), G(ye, {
				grow: 1,
				fit: "tight",
					...
					return G(Ae, {
						...
						get children() {
							return [G(ye, { get children() {
								return G(be, { children: "page-A" });
							} }), G(ye, { get children() {
								return G(be, { children: "page-B" });
							} })];
						}
					});
				}
	...
	var Sliver = () => G(ye, {
		...
		get children() {
			return G(je, {
				length: 2,
				get children() {
					return G(Me, { get children() {
						return [G(Re, {
							pinned: true,
							get title() {
								return G(be, { children: "Tabbed" });
							},
							get bottom() {
								return G(ke, { get children() {
									return [G(Oe, { text: "sliver-A" }), G(Oe, { text: "sliver-B" })];
								} });
							},
							bottomHeight: 48
						}), G(Ke, { get children() {
							return G(Ae, { get children() {
								return [G(ye, { get children() {
									return G(be, { children: "sliver-page-A" });
								} }), G(ye, { get children() {
									return G(be, { children: "sliver-page-B" });
								} })];
							} });
						} })];
					} });
