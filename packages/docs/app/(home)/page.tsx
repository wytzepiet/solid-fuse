  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative mx-2.5 mt-2.5 overflow-hidden rounded-2xl border border-white/5 bg-[#0d0d0f]">
        ...
        <DotGrid color="rgba(212, 147, 89, 0.25)" glow={{ x: 0.78, y: 0.25, radius: 0.45, intensity: 0.5 }} />
        ...
        <div className="relative z-10 px-8 pt-14 md:px-14">
          ...
          <h1 className="mb-10 max-w-[680px] text-[52px] font-medium leading-[1.05] tracking-[-0.035em] md:text-[72px]">
            Solid&apos;s reactivity.
            <br />
            Flutter&apos;s engine.
          </h1>
          <div className="mb-16 flex gap-2.5">
            <Link
              ...
              style={{ ...mono, background: 'var(--fuse-accent)', color: '#18120a' }}
            >
              get started
            </Link>
            <a
      ...
      <section className="px-8 py-28 md:px-14">
        <p className="max-w-[820px] text-[32px] font-medium leading-snug tracking-tight text-[#e8e6e0] md:text-[40px]">
          ...
          <span className="text-[var(--fuse-accent)]">native apps</span>{' '}
          with <a href="https://www.solidjs.com/" className="underline decoration-white/40 underline-offset-4 hover:decoration-white/60">SolidJS</a> and <a href="https://flutter.dev/" className="underline decoration-white/40 underline-offset-4 hover:decoration-white/60">Flutter</a>. Reactive signals drive real widgets through an embedded JS engine.{' '}
          <span className="text-[#76746e]">
            No webview, no bridge serialization, no compromise. Write TSX, render with Impeller, ship to all platforms.
          </span>
        </p>
      </section>
      ...
      <section className="px-8 pb-28 md:px-14">
        <div className="mb-3" style={mono}>
          <span className="text-[11px] uppercase tracking-[0.1em] text-[var(--fuse-accent)]">01 &mdash; features</span>
        </div>
      ...
      <section className="relative mx-2.5 overflow-hidden rounded-2xl border border-white/5 bg-[#0d0d0f]">
        ...
        <DotGrid color="rgba(212, 147, 89, 0.12)" spacing={14} glow={{ x: 0.35, y: 0.3, radius: 0.7, intensity: 0.3 }} />
        <div className="relative z-10 px-8 py-28 md:px-14">
          <div className="mb-3" style={mono}>
            <span className="text-[11px] uppercase tracking-[0.1em] text-[var(--fuse-accent)]">02 &mdash; architecture</span>
          </div>
          ...
          <div className="flex items-stretch justify-center gap-1">
            {[
              ...
              <div key={node.label} className="flex items-start">
                ...
                {i < arr.length - 1 && (
                  <span className="self-start mt-4 px-2 text-sm text-[#3a3936]" style={mono}>
                    {'\u2192'}
                  </span>
                )}
              </div>
      ...
      <section className="px-8 pb-28 md:px-14">
        <div className="mb-3" style={mono}>
          <span className="text-[11px] uppercase tracking-[0.1em] text-[var(--fuse-accent)]">04 &mdash; comparison</span>
        </div>
                ...
                <tr key={ri}>
                  {row.map((cell, ci) => {
                    ...
                    if (typeof cell === 'string') {
                      content = ci === 0
                        ? <span className="font-medium text-[#e8e6e0]">{cell}</span>
                        : cell;
                    } else {
      ...
      <section className="relative mx-2.5 overflow-hidden rounded-2xl border border-white/5 bg-[#0d0d0f]">
        ...
        <DotGrid color="rgba(212, 147, 89, 0.12)" spacing={14} glow={{ x: 0.5, y: 0.4, radius: 0.6, intensity: 0.3 }} />
      ...
      >
        ...
        <div className="flex gap-5">
          <Link href="/docs" className="hover:text-[#76746e]">docs</Link>
          <a href="https://github.com/wytzepiet/solid-fuse" className="hover:text-[#76746e]">github</a>
        </div>
      </footer>
    </div>
  );
